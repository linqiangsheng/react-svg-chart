...
var DashboardCircleChart = function (_React$Component) {
	_inherits(DashboardCircleChart, _React$Component);

	function DashboardCircleChart(props) {
		_classCallCheck(this, DashboardCircleChart);

		var _this = _possibleConstructorReturn(this, (DashboardCircleChart.__proto__ || Object.getPrototypeOf(DashboardCircleChart)).call(this, props));
  ...
  */
	...
	_createClass(DashboardCircleChart, [{
		...
		value: function defineLinearGradient() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'linearGradient',
					{ id: this.gradientIdPre, x1: '0', y1: '300', x2: '50', y2: '0', gradientUnits: 'userSpaceOnUse' },
					(0, _map3.default)(preColors, function (item, index) {
						return _react2.default.createElement('stop', { key: item, offset: index * prePercent + '%', style: { stopColor: item } });
					})
				),
				_react2.default.createElement(
					'linearGradient',
					{ id: this.gradientIdSuf, x1: '50', y1: '0', x2: '', y2: '300', gradientUnits: 'userSpaceOnUse' },
					(0, _map3.default)(sufColors, function (item, index) {
						return _react2.default.createElement('stop', { key: item, offset: index * sufPercent + '%', style: { stopColor: item } });
					})
				)
			);
		}
   ...
   */
		...
		value: function move(prev, next) {
			...
			var _props3 = this.props,
			    ...
			    _props3$colors = _props3.colors,
			    colors = _props3$colors === undefined ? ['#B78BEE', '#1790DC'] : _props3$colors;
   ...
   */
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ x: '50%', y: '47%',
						...
						fill: '' + (valueColor ? valueColor : colors[colors.length - 1]) },
					value > max ? max : value
				),
				_react2.default.createElement(
					'text',
				...
				isScaleVisible && [_react2.default.createElement(
					'text',
					{ key: 'scale-0', x: start.x + 3, y: start.y + 30,
						className: 'text-scale' },
					'0'
				), _react2.default.createElement(
					'text',
					{ key: 'scale-max', x: end.x, y: end.y + 30,
						className: 'text-scale' },
					max
				)]
			);
	...
	return DashboardCircleChart;
}(_react2.default.Component);

exports.default = DashboardCircleChart;